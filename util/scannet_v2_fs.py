...
class Scannetv2_FS_TEST(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return read_episode(file_name) + read_episode_proposals(file_name)
...
def read_episode_proposals(file_name):
    ...
    x = ck_name.split(".")
    file = x[0] + "_2048." + x[1]
    path = os.path.join(dir_name, 'proposals_cut_seed1024_iou_0.7_nms_0.7', ck_name)
    path_n = os.path.join(dir_name, 'proposals_cut_seed1024_iou_0.7_nms_0.7', file)
